...
public class MyCollection implements CI {
    ...
    public static void main(String[] args) {
        ...
        str.add("222");
        str.add("333");
        System.out.println("Простое добавление " + str.toString());
        str.add(2, "444");
        System.out.println("Добавление по индексу с заменой " + str.toString());
        str.add(2, "555");
        System.out.println(str.toString());
        str.add("666");
        System.out.println(str.toString());
        str.add(6, "777");
        System.out.println("Добавление по индексу в конец " + str.toString());
        str.add("888");
        str.delete("666");
        System.out.println("Удаление " + str.toString());
    ...
    public boolean equals(MyCollection str) {
        int counter = 0;
        if (this.collection.length != str.collection.length) {
            return false;
        }
        for (int i = 0; i < collection.length; i++) {
    ...
    public String[] getNewCollection(int newSize, String[] oldCollection) {
